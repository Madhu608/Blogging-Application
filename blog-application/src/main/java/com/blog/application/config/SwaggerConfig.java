...
public class SwaggerConfig {
	...
	return new OpenAPI()
			...
			.description("This Project is Developed by Madhu S")
			.version("3.1.6")
			.contact(new io.swagger.v3.oas.models.info.Contact().name("Madhu S").email("madhus2483@gmail.com").url("https://github.com/Darshannayaka?tab=repositories"))
